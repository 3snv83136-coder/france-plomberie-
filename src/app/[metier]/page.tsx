      ...
      {trade.slug === "plombier" && (
        <section className="container mb-10">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Canalisation, WC, évier ou douche bouché ? Notre spécialiste du
            débouchage intervient en urgence partout en France.
          </p>
            ...
            <div className="md:flex items-center justify-between gap-6">
              <div className="flex-1">
                ...
                <p className="text-white/85 mb-4">
                  Débouchage de canalisations partout en France. Intervention
                  rapide, devis gratuit, sans surprise.
                </p>
